...
export interface ApiBlogAuthorBlogAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AuthorBio: Schema.Attribute.RichText;
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blog_authors: Schema.Attribute.Relation<
      'manyToMany',
      'api::blog-author.blog-author'
    >;
    BlogPostBody: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    TextPreviewSnippet: Schema.Attribute.Text;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AmazonASIN: Schema.Attribute.String;
    AmazonLink: Schema.Attribute.String;
    AmazonPhotoURL: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cocktailIngredients: Schema.Attribute.JSON & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ingredients: Schema.Attribute.RichText;
    isShortformVideo: Schema.Attribute.Boolean;
    ...
    > &
      Schema.Attribute.Private;
    PhotoMain: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    PhotoPinterest: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    ratingTotal: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    recipebody: Schema.Attribute.RichText;
    RecipeIntro: Schema.Attribute.RichText;
    recipeUrlSlug: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiSpiritSpirit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    spirit: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
